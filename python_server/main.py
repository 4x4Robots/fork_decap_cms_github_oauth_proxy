...
GITHUB_AUTHORIZE_URL = "https://github.tik.uni-stuttgart.de/login/oauth/authorize"
GITHUB_TOKEN_URL = "https://github.tik.uni-stuttgart.de/login/oauth/access_token"
